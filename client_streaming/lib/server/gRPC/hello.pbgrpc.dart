...
class HelloClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.responseHello> sayHelllo($async.Stream<$0.callHello> request, {$grpc.CallOptions? options}) {
...
abstract class HelloServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.responseHello> sayHelllo($grpc.ServiceCall call, $async.Stream<$0.callHello> request);
}
